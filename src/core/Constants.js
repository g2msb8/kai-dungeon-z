...
export const SPECIAL = {
  ...
  ENLARGE_DURATION: 15,
  ENLARGE_SCALE: 2.0,
  ENLARGE_SPEED_MULT: 2.0,

  // 魔力破壊
  MAGIC_SLASH_COUNT: 8,
  MAGIC_SLASH_DURATION: 1.0,
  MAGIC_DESTROY_DELAY: 1.5,
  MAGIC_DESTROY_RADIUS: 10.2,

  // ストーンゴーレム
  GOLEM_STUN_RADIUS: 7.5,
  GOLEM_STUN_DURATION: 11,
  GOLEM_LIFE: 40,
  GOLEM_SLAM_COOLDOWN: 14,
};
